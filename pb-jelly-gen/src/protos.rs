    ...
    pub mod compiler {
      pub mod plugin {
        ...
        impl CodeGeneratorRequest {
          ...
          pub fn set_proto_file(&mut self, v: ::std::vec::Vec<super::super::super::super::google::protobuf::descriptor::FileDescriptorProto>) {
            self.proto_file = v;
          }
          pub fn take_proto_file(&mut self) -> ::std::vec::Vec<super::super::super::super::google::protobuf::descriptor::FileDescriptorProto> {
            ::std::mem::take(&mut self.proto_file)
          }
          pub fn get_proto_file(&self) -> &[super::super::super::super::google::protobuf::descriptor::FileDescriptorProto] {
            &self.proto_file
          }
        ...
        pub struct CodeGeneratorResponse_File {
          ...
          pub generated_code_info: ::std::option::Option<super::super::super::super::google::protobuf::descriptor::GeneratedCodeInfo>,
        }
        impl CodeGeneratorResponse_File {
          ...
          pub fn set_generated_code_info(&mut self, v: super::super::super::super::google::protobuf::descriptor::GeneratedCodeInfo) {
            self.generated_code_info = Some(v);
          }
          pub fn take_generated_code_info(&mut self) -> super::super::super::super::google::protobuf::descriptor::GeneratedCodeInfo {
            self.generated_code_info.take().unwrap_or_default()
          }
          pub fn get_generated_code_info(&self) -> &super::super::super::super::google::protobuf::descriptor::GeneratedCodeInfo {
            self.generated_code_info.as_ref().unwrap_or(&super::super::super::super::google::protobuf::descriptor::GeneratedCodeInfo_default)
          }
        }
          ...
          fn deserialize<B: ::pb_jelly::PbBufferReader>(&mut self, mut buf: &mut B) -> ::std::io::Result<()> {
            while let Some((field_number, typ)) = ::pb_jelly::wire_format::read(&mut buf)? {
              match field_number {
                ...
                16 => {
                  let val = ::pb_jelly::helpers::deserialize_length_delimited::<B, super::super::super::super::google::protobuf::descriptor::GeneratedCodeInfo>(buf, typ, "CodeGeneratorResponse_File", 16)?;
